...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Admin - Online Shop'; ?></title>
</head>
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin.php?page=products">Products</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-user"></i> <?php echo Session::getEmail(); ?>
                    </a>
...
<footer class="mt-5 py-3 bg-dark text-white">
    <div class="container text-center">
        <p class="mb-0">&copy; <?php echo date('Y'); ?> Online Shop Admin Panel. All rights reserved.</p>
    </div>
</footer>
